...
const BundleProduct = ({
  ...
  return (
    <div className="mt-2 p-3 border border-gray-200 rounded-md shadow-sm bg-gray-50">
      <h4 className="font-bold text-gray-800">
        {product.NombreProducto} x{product.Cantidad}
      </h4>

      <div className="relative mt-4 p-2 bg-white rounded-md shadow-sm border border-gray-300">
